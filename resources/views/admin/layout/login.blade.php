...
{{--					}--}}
			...
			<li><a href="{{url('admin/login/login')}}"><i class="fa fa-sign-in"></i>Login</a></li>
			<li><a href="{{url('admin/login/register')}}"><i class="fa fa-user-plus"></i>Register</a></li>
			<li><a href="{{url('admin/login/tc')}}">retreat from</a></li>
		</ul>
	</div>
	<!-- end side nav right-->
