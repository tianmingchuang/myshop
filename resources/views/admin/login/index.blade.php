	...
	<div class="section product">
		<div class="container">
			...
			<div class="row">
				<div class="col s6">
					<div class="content">
						<a href="{{url('admin/login/shop_single',['id'=>$v->id])}}"><img src="{{$v->goods_pic}}" alt=""></a>
						<h6><a href="{{url('admin/login/shop_single',['id'=>$v->id])}}">{{$v->goods_name}}</a></h6>
						<div class="price">
							{{$v->goods_price}} <span>$28</span>
						</div>
						<a href="{{url('admin/login/shop_single',['id'=>$v->id])}}" class="btn button-default">ADD TO CART</a>
